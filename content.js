...
function amazonCode() {
  ...
  if (grid) {
    ...
    `;
      grid.insertBefore(componentContainer, grid.children[1]);
    } else {
...
function createUI(title, description, url, imageUrl) {
  ...
  if (searchResult) {
    ...
    img.src =
      "https://as2.ftcdn.net/v2/jpg/02/94/54/07/1000_F_294540722_VIwSWyrU6q781SkHWSlzUDXjfouRlj47.jpg"; // Placeholder image, replace with your own image source
